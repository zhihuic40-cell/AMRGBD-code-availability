...
ggsave(file.path(results_dir, "FigureS1_PF1aba.pdf"), PF1aba, width = 10.22, height = 6.81)
ggsave(file.path(results_dir, "FigureS1_PF1cit.pdf"), PF1cit, width = 10.22, height = 6.81)
ggsave(file.path(results_dir, "FigureS1_PF1ent.pdf"), PF1ent, width = 10.22, height = 6.81)
ggsave(file.path(results_dir, "FigureS1_PF1eco.pdf"), PF1eco, width = 10.22, height = 6.81)
ggsave(file.path(results_dir, "FigureS1_PF1kpn.pdf"), PF1kpn, width = 10.22, height = 6.81)
ggsave(file.path(results_dir, "FigureS1_PF1pae.pdf"), PF1pae, width = 10.22, height = 6.81)
ggsave(file.path(results_dir, "FigureS1_PF1ser.pdf"), PF1ser, width = 10.22, height = 6.81)
cat("✓ All FigureS1 left panel plots saved to results directory\n")
