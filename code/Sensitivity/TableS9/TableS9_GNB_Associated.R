...
ORIGINAL_SCRIPT_NAME <- "Figure6_GNB_Associated.R"
...
diag_log_override <- Sys.getenv("FIGURE6_DIAGNOSTIC_LOG_FILE", unset = "")
DIAGNOSTIC_LOG_FILE <- if (nzchar(diag_log_override)) {
  diag_log_override
} else {
  file.path(
