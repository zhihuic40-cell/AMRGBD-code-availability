...
file_path <- file.path(data_dir, "assnumberper.csv")
...
output_file <- file.path(results_dir, "Figure1B.pdf")
ggsave(output_file, p2, width = 10.68, height = 7.1, units = "in",
       device = cairo_pdf)
