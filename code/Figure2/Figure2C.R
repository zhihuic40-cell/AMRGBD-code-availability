# ==============================================================================
# Figure 2C: Global Distribution of ASS Net Drift
# ==============================================================================
# Description: This script generates a world map showing the net drift in 
# age-standardized mortality rate for antimicrobial-susceptible staphylococcal 
# infections (ASS).
#
# Input files:
#   - data/ass-ndrift.csv: GBD data for ASS net drift
...
GBD <- read.csv(file.path(data_dir, "ass-ndrift.csv"), header = TRUE)
...
output_file <- file.path(results_dir, "Figure2C.pdf")
