# ==============================================================================
# Figure 2B: Global Distribution of ATT-attributed Deaths in 2021
# ==============================================================================
# Description: This script generates a world map showing the age-standardized 
# mortality rate (ASR) for deaths attributed to antimicrobial-treated 
# staphylococcal infections (ATT) in 2021.
#
# Input files:
#   - data/att-death2021GNB.csv: GBD data for ATT deaths
...
GBD <- read.csv(file.path(data_dir, "att-death2021GNB.csv"), header = TRUE)
...
output_file <- file.path(results_dir, "Figure2B.pdf")
