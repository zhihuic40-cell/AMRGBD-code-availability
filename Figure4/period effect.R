...
# Build panel data for each region
...
# Helper to get combined y-range
...
# Compute ranges for all regions
ranges <- list(
...
# Compute overall min/max and print
...
# Save figure
ggsave("period_rate_ratio.pdf", final_plot, width = 15, height = 8)
